...
// Dev-only module.json: includes all relationships (e.g. quench).
// Release module.json is generated by scripts/release.mjs which filters
// out dev-only deps and adds manifest/download URLs.
